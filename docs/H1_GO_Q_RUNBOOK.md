...
3. **Modo operario** (30 s — tablero + 4 actos):
   ...
   # ensayo vivo de los 4 actos (opcional):
...
|-----|--------|-----------|
| 0–2 | Gancho: decisión auditada + abstención | Card / pack README |
...
| 10–12 | Pack + replay en vivo | `python -m wildfire_front operator do --act 4` (equiv. `demo-third-party`) |
