#!/usr/bin/env python3
"""U-Net training v20 — Residual + changed-pixel pivot (Kaggle-safe).

Single variable vs v19: ResidualWildfireUNetSmall (--architecture residual).
Hypothesis: copy-anchored logits recover full-grid IoU while keeping Tier-1 gains.
"""
...
parser = argparse.ArgumentParser(description="Wildfire U-Net v20 — residual + changed-pixel")
...
parser.add_argument("--version-tag", type=str, default="v20")
parser.add_argument(
    "--filter-mode",
...
print("=" * 70)
print("WILDFIRE U-NET v20 — RESIDUAL + CHANGED-PIXEL")
print("=" * 70)
