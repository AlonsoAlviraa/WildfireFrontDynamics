#!/usr/bin/env python3
"""v27b — temporal rail T=3 (last G1 temporal attempt after T=2 flat vs v21)."""
...
parser = argparse.ArgumentParser(description="v27b temporal T=3")
...
parser.add_argument("--data-dir", type=str, default="/tmp/ndws_npz_legacy17_t3")
parser.add_argument("--output-dir", type=str, default=None)
parser.add_argument("--version-tag", type=str, default="v27b_temporal_t3")
...
print("=" * 70)
print("V27b TEMPORAL T=3 — last G1 temporal shot")
print("=" * 70)
_clone()
