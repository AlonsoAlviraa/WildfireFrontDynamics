...
# Re-export for callers that import coreg from front_dynamics.
__all__ = (
    "FrontDynamicsResult",
    "PairDynamics",
    "build_structural_operational_bundle",
    "estimate_coreg_translation",
    "perimeter_m",
    "run_front_dynamics",
    "total_perimeter_m",
    ...
    *,
    ...
    for i in range(1, len(observations)):
        ...
        if coreg.get("applied", 0) > 0:
            ...
            aligned.append(shift_observation(curr, cum_dx, cum_dy))
        else:
            aligned.append(shift_observation(curr, cum_dx, cum_dy) if (cum_dx or cum_dy) else curr)
